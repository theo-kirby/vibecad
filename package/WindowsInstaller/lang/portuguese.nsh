...
${LangFileString} TEXT_WELCOME "Este assistente de instalação irá guiá-lo através da instalação do VibeCAD.$\r$\n\
				$\r$\n\
				$_CLICK"
...
${LangFileString} TEXT_FINISH_WEBSITE "Visite github.com/10-X-eng/vibecad para as últimas notícias, suporte e dicas"
...
${LangFileString} SecCoreDescription "Os ficheiros VibeCAD."
#${LangFileString} SecAllUsersDescription "Instalar o VibeCAD para todos os utilizadores ou apenas para o presente utilizador."
${LangFileString} SecFileAssocDescription "Os ficheiros com a extensão .FCStd irão abrir automaticamente no VibeCAD."
${LangFileString} SecDesktopDescription "Um icone do VibeCAD no ambiente de trabalho."
...
#${LangFileString} ConfigInfo "A configuração seguinte do VibeCAD irá demorar um bocado."
...
${LangFileString} AlreadyInstalled "O VibeCAD ${APP_SERIES_KEY2} já está instalado!$\r$\n\
				...
				Nestes casos é melhor reinstalar o VibeCAD$\r$\n\
				Quer continuar na mesma a instalar o VibeCAD sobre a versão existente?"
${LangFileString} NewerInstalled "Está a tentar instalar uma versão mais antiga do que a que tem instalada.$\r$\n\
				  Se realmente quer fazer isto deve antes desinstalar o VibeCAD $OldVersionNumber."

#${LangFileString} FinishPageMessage "Parabéns! O VibeCAD foi instalado com sucesso.$\r$\n\
#					$\r$\n\
#					(O primeiro início do VibeCAD pode levar alguns segundos.)"
${LangFileString} FinishPageRun "Lançar o VibeCAD"

${LangFileString} UnNotInRegistryLabel "Incapaz de encontrar o VibeCAD no registry.$\r$\n\
					Os atalhos para o ambiente de trabalho no menu Start não serão removidos."
${LangFileString} UnInstallRunning "Deve fechar o VibeCAD em primeiro lugar!"
${LangFileString} UnNotAdminLabel "Precisa de privilégios de administrador para desinstalar o VibeCAD!"
${LangFileString} UnReallyRemoveLabel "Tem a certeza que quer remover completamente o VibeCAD e todas as suas componentes?"
${LangFileString} UnFreeCADPreferencesTitle 'Preferências de utilizador do VibeCAD'

#${LangFileString} SecUnProgDescription "Desinstala xxx."
${LangFileString} SecUnPreferencesDescription 'Apaga as pastas de configuração do  VibeCAD$\r$\n\
						$\"$AppPre\username\$\r$\n\
						$AppSuff\$\r$\n\
						${APP_DIR_USERDATA}$\")$\r$\n\
...
${LangFileString} SecUnProgramFilesDescription "Desinstala VibeCAD e todas as suas componentes."
