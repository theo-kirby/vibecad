...
class _Roof(ArchComponent.Component):
    ...
    def createProfilShape(self, points, midpoint, rot, vec, run, diag, sol):
        ...
        except FreeCAD.Base.CADKernelError as err:
            FreeCAD.Console.PrintWarning(f"Arch Roof: skipped invalid roof profile: {err}\n")
            return None
            ...
            if baseWire.isClosed():
                ...
                for i in range(ln):
                    ...
                    if face:
                        ...
                        profil_shape = self.createProfilShape(
                            ptsPaneProfil,
                            midpoint,
                            profilCurr["rot"],
                            profilCurr["vec"],
                        ...
                        subvolume_shape = self.createProfilShape(
                            ptsSubVolProfil,
                            midpoint,
                            profilCurr["rot"],
                            profilCurr["vec"],
                        ...
                        if subvolume_shape:
                            self.subVolShps.append(subvolume_shape)
