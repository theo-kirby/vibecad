...
class QuantityPropertyEditorWidget(BasePropertyEditorWidget):
    ...
    def updateWidget(self):
        ...
        self._editor_widget.setProperty("unit", value.getUserPreferred()[2])
        self._editor_widget.setProperty("rawValue", value.Value)
    ...
    def updateProperty(self):
        ...
        new_value = FreeCAD.Units.Quantity(
            self._editor_widget.property("rawValue"),
            current_value.Unit,
        )
