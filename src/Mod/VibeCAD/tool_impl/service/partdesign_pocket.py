    ...
    "parameters": {
        ...
        "properties": {
            ...
            "side": {
                ...
                "description": "Cut one side of the sketch plane, both with separate lengths, or symmetrically.",
            },
            "reversed": {
                "type": "boolean",
                "description": "Cut opposite the sketch normal; usually false.",
            },
            "taper_angle_degrees": {
                "type": "number",
            ...
            "direction": {
                **partdesign_linear_feature.VECTOR_SCHEMA,
                "description": "Custom cut direction; omit to follow the sketch normal.",
            },
            "refine": {
                "type": "boolean",
